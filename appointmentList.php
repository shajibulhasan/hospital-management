...
<?php
  $s = "select r.problem as problem, r.id as id, r.status as status, r.Report as report, u.name as name, d.name as dName from records as r INNER JOIN users as u ON r.userId = u.id INNER JOIN doctors as d ON r.doctorId = d.id where r.report = 'Waiting'";
