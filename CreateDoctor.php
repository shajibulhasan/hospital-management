          ...
          <div class="content-wrapper">
            ...
            <form action="" method="post">
                  ...
                  <div class="form-group">
                      ...
                      <input type="text" class="form-control" value="" id="qualification" name="qualification">
                  </div>
                  <div class="form-group">
                      <button type="submit" class="btn btn-primary" name="btnCreate">Create Doctor</button>
                  </div>
              </form>
...
<?php  
    if(isset($_POST['btnCreate'])){
        ...
        $role = 'Doctor';
        $s1 = "insert into doctors(name, email, password, phone, address, role, qualification)
              values('".$name."', '".$email."', '".$password."', '".$phone."', '".$address."', '".$role."', '".$qualification."')";
        if(mysqli_query($conn, $s1)){                      
            echo 'Successfully Create Doctor.';   
        }
    }
?>