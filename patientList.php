...
<?php
    $s = "select r.id as id, r.Report as report, r.problem as problem, u.name as name from records as r INNER JOIN users as u ON r.userId = u.id where r.report != 'Waiting' and r.doctorId = $id";
